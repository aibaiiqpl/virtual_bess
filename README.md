...
pv:
  rated_power_kw: 120        # 光伏额定发电功率 kW
...
1. BMS 合闸：写 40001 = 1
2. PCS 开机：写 30003 = 1
3. 下发功率：写 30010 或 3010 = 500（充电 50kW）或 -500（放电 50kW）
...
| 30010/3010 | 充放电功率指令 | S16  | 0.1kW，正充负放              |
...
> 60002 和 60003 以最新写入的寄存器为准。光伏默认开机，6:00-18:00 按日曲线发电，13:00-15:00 达到峰值，峰值为额定功率的 90%。
...
| 60280     | PV直流输入总功率 | S16  | 0.1   | kW   |
| 60281     | 逆变器内部温度   | S16  | 0.1   | °C   |
| 60282     | PV总线直流侧总电压 | U16 | 0.1   | V    |
| 60283     | PV总线直流侧总电流 | S16 | 0.1   | A    |
